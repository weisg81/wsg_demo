...
public final class MyDataInfo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using pers.weisg.base.springboot_demo.netty.codec2.MyDataInfo.MyMessage.newBuilder()
      private Builder() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SNO_FIELD_NUMBER = 3;
    private volatile Object sno_;
    /**
     * <code>string sno = 3;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getSnoBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 3, sno_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!getSnoBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(3, sno_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final Object obj) {
      ...
      if (!getSno()
          .equals(other.getSno())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public static final class Builder extends
      ...
      // Construct using pers.weisg.base.springboot_demo.netty.codec2.MyDataInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    throw new NullPointerException();
      ...
      public Builder clearSno() {
        ...
        sno_ = getDefaultInstance().getSno();
        onChanged();
        return this;
      }
      /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using pers.weisg.base.springboot_demo.netty.codec2.MyDataInfo.Worker.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  static {
    String[] descriptorData = {
      ...
      "isg.base.springboot_demo.netty.codec2B\nM" +
